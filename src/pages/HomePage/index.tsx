...
const HomePage = () => {
  ...
  const hobbyProject = [
    ...
    },
    {
      id: 2,
      title: 'PSP Kanban',
      description: 'Kanban for our hobby game projects, using Supabase realtime/presence, fast updates and see all the users currently editing/watching. Login/auth via Supabase',
